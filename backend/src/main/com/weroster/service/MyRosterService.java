...
public class MyRosterService {
    ...
    public main.com.weroster.Dto.DayViewDto dayView(String email, Long uid, LocalDate date) {
        Long staffId = resolveStaffId(email, uid);
        // 日窗：按产品定义，AM 8:00 ~ PM 23:59
        LocalTime WIN_START = LocalTime.of(8, 0);
        LocalTime WIN_END   = LocalTime.of(23, 59);
        var window = new main.com.weroster.Dto.DayWindowDto(WIN_START.toString(), WIN_END.toString());

        if (staffId == null) {
            return new main.com.weroster.Dto.DayViewDto(
                    date.toString(), window,
                    java.util.List.of(),
                    java.util.List.of(new main.com.weroster.Dto.UnallocatedItemDto(
        ...
        List<main.com.weroster.Dto.AllocatedItemDto> allocated = jdbc.query(sql, (rs,i) -> {
                    ...
                    return new main.com.weroster.Dto.AllocatedItemDto(
                            shiftId,
                            startHHmm,
                            endHHmm,
        ...
        List<main.com.weroster.Dto.UnallocatedItemDto> unallocated = new ArrayList<>();
        ...
        for (var b : blocks) {
            if (b[0].isAfter(cursor)) {
                unallocated.add(new main.com.weroster.Dto.UnallocatedItemDto(
