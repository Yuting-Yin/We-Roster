...
export default function FailToast({ visible, text }: { visible: boolean; text: string }) {
  ...
  return (
    <Animated.View pointerEvents="none" style={[styles.wrap, { transform: [{ translateY }], opacity }]}>
      <Ionicons name="close-circle-outline" size={sx(18)} color={COLOR.red} />
...
const styles = StyleSheet.create({
  wrap: {
    ...
    backgroundColor: COLOR.redBg, borderWidth: 1, borderColor: COLOR.red,
  ...
  txt: { marginLeft: sx(8), color: COLOR.red, 
